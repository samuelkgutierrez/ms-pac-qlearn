...
{	
    ...
    {
    	bufferGraphics.setColor(Color.WHITE);
    	bufferGraphics.drawString("TRIALS: "+game.getPacmanNumberOfLivesRemaining(), 4, 271);
    	bufferGraphics.drawString("REWARD: "+game.getScore(),100,271);
    ...
    {
    	bufferGraphics.setColor(Color.WHITE);
    	if(game.endWhenPillsGone && game.pacmanWin)
    	{
        	bufferGraphics.drawString("Complete",85,150);    		
    	}
    	else
    	{
